...
namespace GeekShopping.IdentityServer.Initializer
{
	public class DbInitializer : IDBInitiliazer
	{
		...
		public void Initialize()
		{
			...
			{
				UserName = "paulor-admin",
				Email = "paulor-admin@servidor.com.br",
				EmailConfirmed = true,
			...
			_user.CreateAsync(admin, "Paulo123$").GetAwaiter().GetResult();
			...
			{
				UserName = "paulor-client",
				Email = "paulor-client@servidor.com.br",
				EmailConfirmed = true,
				PhoneNumber = "+55 (34) 12345-6789",
				FirstName = "Paulo",
				LastName = "Ricardo"
			...
			_user.CreateAsync(client, "Paulo123$").GetAwaiter().GetResult();
